...
exports.buildProjectionExpression = void 0;
/**
...
function buildProjectionExpression(tableClass, attributes) {
    const projection = [];
    const map = {};
    let i = 0;
...
//# sourceMappingURL=projection-expression.js.map