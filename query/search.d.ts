...
import { AttributeNames, Filters } from './filters';
...
declare type Index<T extends Table> = PrimaryKey<T, any, any> | GlobalSecondaryIndex<T> | LocalSecondaryIndex<T> | string;
...
export declare type SearchGroupFunction<T extends Table> = (condition: MagicSearch<T>) => any;
/**
...
export declare class MagicSearch<T extends Table> {
    ...
    filter<K1 extends AttributeNames<T>>(a1: K1): Condition<T, Attr, T[K1]>;
    filter<K1 extends AttributeNames<T>, K2 extends keyof T[K1]>(a1: K1, a2: K2): Condition<T, Attr, T[K1][K2]>;
    filter<K1 extends AttributeNames<T>, K2 extends keyof T[K1], K3 extends keyof T[K1][K2]>(a1: K1, a2: K2, a3: K3): Condition<T, Attr, T[K1][K2][K3]>;
    filter<K1 extends AttributeNames<T>, K2 extends keyof T[K1], K3 extends keyof T[K1][K2], K4 extends keyof T[K1][K2][K3]>(a1: K1, a2: K2, a3: K3, a4: K4): Condition<T, Attr, T[K1][K2][K3][K4]>;
    where<K1 extends AttributeNames<T>>(a1: K1): Condition<T, Attr, T[K1]>;
    where<K1 extends AttributeNames<T>, K2 extends keyof T[K1]>(a1: K1, a2: K2): Condition<T, Attr, T[K1][K2]>;
    where<K1 extends AttributeNames<T>, K2 extends keyof T[K1], K3 extends keyof T[K1][K2]>(a1: K1, a2: K2, a3: K3): Condition<T, Attr, T[K1][K2][K3]>;
    where<K1 extends AttributeNames<T>, K2 extends keyof T[K1], K3 extends keyof T[K1][K2], K4 extends keyof T[K1][K2][K3]>(a1: K1, a2: K2, a3: K3, a4: K4): Condition<T, Attr, T[K1][K2][K3][K4]>;
    or(): this;
    and(): this;
    /**
    ...
    */
     ...
     */
    consistent(consistent?: DynamoDB.ConsistentRead): this;
    /**
    ...
    */
    ...
    page(input: DynamoDB.ScanInput | DynamoDB.QueryInput): Promise<QueryOutput<T>>;
